...
import "/Users/sahilapte/Documents/project school stuff/acer/Autosurgury_website-main/client/src/App.css"
...
const Homepage = (props) => {
    ...
    return (
        ...
        <div className="home">
            ...
            <br />
            <div className="chocolate" style={{backgroundColor:'#222222'}}>
            <Grid container spacing={2} style={{ paddingLeft: "30px", paddingTop: "10px"}}>
                       <h1> Hello {props.details.user.name} 😃</h1>
                <Grid xs={11}>
            ...
            <br />
            <Typography align ="center"><b><u><i>Upload Image down here</i></u></b></Typography>
            <br></br>
            <br></br>
            <Box
                display="flex"
                ...
                <div className="homepage" >
                    ...
                    {selectedFile && <img src={preview} style={{ maxWidth: "728px", maxHeight: "1000px" }} />}<br /> <br />
                    <Button variant="contained" color="secondary" onClick={detect} >
                        Predict Image
                    </Button><br /><br />
                </div>
            </Box>
            {processing1 && processing2 ? (<h1>proce    ssing.......</h1>) :
                (<div>
                    {detected && <h1 style={{ paddingLeft: "50px" }}>Detected Image:</h1>}
                    <Grid container spacing={2} style={{ paddingLeft: "200px", paddingTop: "10px" }}>
                        <Grid xs={8}>
                            <div>
                                {detected && <img src={detected} style={{ maxWidth: "728px", maxHeight: "1000px" }} />}
                            </div>
                        </Grid>
                        <Grid xs={4}>
                            <div>
                    ...
                    <Grid container spacing={2} style={{ paddingLeft: "200px", paddingTop: "10px" }}>
                        <Grid xs={8}>
                            <div>
                                {semantic && <img src={semantic} style={{ maxWidth: "800px", maxHeight: "1000px" }} />}
                            </div>
                        </Grid>
                        <Grid xs={4}>
                            <div>
