        ...
        <div className="home">
            ...
            >
                <div className="homepage">
                    ...
                    {selectedFile && <img alt = "uploading.."src={preview} style={{ maxWidth: "800px", maxHeight: "600px" }} />}<br /> <br />
            ...
            {processing1 && processing2 ? (<h1>processing.......</h1>) :
                (<div>
                    ...
                    <Grid container spacing={2} style={{ paddingLeft: "200px", paddingTop: "10px" }}>
                        <Grid xs={8}>
                            <div>
                                {detected && <img alt = "processing..." src={detected} style={{ maxWidth: "800px", maxHeight: "600px" }} />}
                            </div>
                        </Grid>
                        <Grid xs={4}>
                            <div>
                    ...
                    <Grid container spacing={2} style={{ paddingLeft: "200px", paddingTop: "10px" }}>
                        <Grid xs={8}>
                            <div>
                                {semantic && <img alt = "sending..."src={semantic} style={{ maxWidth: "800px", maxHeight: "600px" }} />}
                            </div>
                        </Grid>
                        <Grid xs={4}>
                            <div>
